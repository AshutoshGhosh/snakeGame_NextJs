    ...
    return (
        <div className="flex flex-col ">
            <div className='flex justify-between items-center mb-3'>
                <span className='p-3 rounded-md bg-pink-400'>
                    Snake Length : {score}
                </span>
                {gameOver && <button onClick={() => { window.location.reload() }} className='p-3 bg-gray-300 rounded-md text-gray-800 hover:shadow-lg hover:bg-blue-800 hover:text-gray-300 transition-colors ease-out  animate-bounce font-semibold'>
                    Restart Game
                </button>}
            </div>
